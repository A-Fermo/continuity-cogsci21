jsPsych.plugins['causal-graph'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var nb_of_run = 0;
    var html_img = '<img id="Graphics" src='+trial.stimulus+' width='+trial.stim_width+' height='+trial.stim_height+'>'
    ...
    var html = html_prompt + html_img + again_btn + continue_btn;
    ...
    display_element.querySelector('#jspsych-causal-graph-again-btn').addEventListener('click', function(){
      ...
      var str = trial.stimulus.split("/")[1].split("_");
